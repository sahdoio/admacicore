            ...
            <div class="card-body">
                <div class="group center">
                    ...
                    <div class="form-group has-label">
                        ...
                        <input class="form-control" value="{{ $member->rg ?? '' }}" name="rg" type="text" required="true" minlength="2"/>
                    </div>
                    <div class="form-group has-label">
                        <label>
                            CPF
                        </label>
                        <input class="form-control" value="{{ $member->cpf ?? '' }}" name="cpf" type="text" required="true" minlength="2"/>
                    </div>
                    <div class="form-group has-label">
                        <label>
                            Data de nascimento
                        </label>
                        <input class="form-control" value="{{ $member->birth_date ?? '' }}" name="birth_date" type="text" required="true" minlength="2"/>
                    </div>
                    <div class="form-group has-label">
                        <label>
                            Nome do Pai
            ...
            <div class="card-body">
                <div class="group center">
                    ...
                    <div class="form-group has-label">
                        ...
                        <input class="form-control" value="{{ $member->baptism_date ?? '' }}" name="baptism_date" type="text" required="true" minlength="2"/>
                    </div>
                </div>
            </div>
        </div>
