                        ...
                        <div class="card-body">
                            <div class="group center">
                                ...
                                <div class="form-group has-label">
                                    ...
                                    <input class="form-control" value="{{ $user->name ?? '' }}" name="name" type="text" required="true" minlength="2"/>
                                </div>
                                <div class="form-group has-label">
                                    <label>
                                        Sobrenome
                                    </label>
                                    <input class="form-control" value="{{ $user->lastname ?? '' }}" name="lastname" type="text" required="true" minlength="2"/>
                                </div>
                                <div class="form-group has-label">
                                    <label>
                                        E-mail
                                    </label>
                                    <input class="form-control" value="{{ $user->email ?? '' }}" name="email" type="text" required="true" minlength="2"/>
                                </div>
                                <div class="col-md-12">
                                    <br>
