            ...
            <div class="form-group">
                <div class="row section">
                    ...
                    <div class="col s12 m8 l9">
                        <p>Text Area</p>
                        <textarea class="form-control" name="title" rows="3" placeholder="Enter Title...">{{ $job->title ?? '' }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row section">
                    ...
                    <div class="col s12 m8 l9">
                        ...
                        @endphp
                        <input type="text" name="date" class="form-control datepicker" value="{{ $job->date ?? '' }}" onkeyup="mascara('##/##/####',this,event)" minlength="10" maxlength="10">
                    </div>
                </div>
            </div>
