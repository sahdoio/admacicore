...
@section('styles')
    ...
    <link rel="stylesheet" href="/admin/css/pages/album_videos/albums.css"/>
@endsection
        ...
        <div class="albums">
            <div class="form-group">
                <div class="row section">
                    <h2 class="section-title col s12 m6">Seus Álbuns de Vídeos</h2>
                    <div class="albums-btn-box col s12 m6">
                        <button id="buttonAdd" type="button" class="btn btn-success add" data-href="{{ route('admin.album_videos.new') }}">
                            Novo
                        </button>
                    </div>
                </div>
                                    ...
                                    <figure class="effect-roxy">
                                        ...
                                        <figcaption>
                                            <div class="button-wrapper">
                                                <button id="btnEdit" type="button" class="btn btn-primary edit" data-edit="{{ route('admin.album_videos.edit', $album->id) }}">Edit</button>
                                                <button id="btnDelete" type="button" class="btn btn-primary delete" data-delete="{{ route('admin.album_videos.delete', $album->id) }}">Delete</button>
                                            </div>
                                            <h2>{{ $album->name }}</h2>
                                            <a href="{{ route('admin.album_videos.edit', $album->id) }}">View more</a>
                                        </figcaption>
                                    </figure>
                                </div>
...
@section('scripts')
    ...
    <script src="/admin/js/pages/album_videos/albums.js"></script>
@endsection