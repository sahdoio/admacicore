                ...
                @if($media->type_id == \App\Models\MediaType::VIMEO)
                    <div class="job-item job-video">
                        <div class="video-box embed-responsive embed-responsive-16by9">
                            <iframe src="{{ \App\Libs\AppUtils::videoInputFormat($media->url) }}" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                @elseif(
...
@if(isset($albums) && count($albums))
    ...
    @include('website.content.album_images_list')
@endif
